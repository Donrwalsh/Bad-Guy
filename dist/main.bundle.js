...
module.exports = "<div *ngIf=\"_scheming.schemes\" class=\"scheme-panel\">\n    <div class=\"select-bar\">\n        <div class=\"schemes select\" (click)=\"selected = 'schemes'\">\n            <i class=\"fa fa-lightbulb-o\" aria-hidden=\"true\"></i>\n        </div>\n        <div class=\"hench select\" (click)=\"selected = 'hench'\">\n            <i class=\"fa fa-user\" aria-hidden=\"true\"></i>\n        </div>\n        <div class=\"operate select\" (click)=\"selected = 'operate'\">\n            <i class=\"fa fa-location-arrow\" aria-hidden=\"true\"></i>\n        </div>\n        <div class=\"lair select\" (click)=\"selected = 'lair'\">\n            <i class=\"fa fa-home\" aria-hidden=\"true\"></i>\n        </div>\n    </div>\n    <div class=\"scheme-area\" *ngIf=\"selected == 'schemes'\">\n        <div class=\"column\">\n            <p class=\"node\">\n                <i class=\"fa {{_scheming.schemes[0].fa}}\" aria-hidden=\"true\" (click)=\"_scheming.schemePreview(0)\"></i>\n            </p>\n            <!--<p class=\"level\">{{_scheming.getSchemeCurrentLevel(0)+1}}</p>-->\n            <p class=\"node\">\n                <i class=\"fa {{_scheming.schemes[1].fa}}\" aria-hidden=\"true\" (click)=\"_scheming.schemePreview(1)\"></i>\n            </p>\n            <!--<p class=\"level\">{{_scheming.getSchemeCurrentLevel(1)+1}}</p>-->\n            <p class=\"node\">\n                <i class=\"fa {{_scheming.schemes[2].fa}}\" aria-hidden=\"true\" (click)=\"_scheming.schemePreview(2)\"></i>\n            </p>\n            <!--<p class=\"level\">{{_scheming.getSchemeCurrentLevel(2)+1}}</p>-->\n        </div>\n        <div class=\"column\"></div>\n        <div class=\"column\"></div>\n        <div class=\"column\"></div>\n        <div class=\"column\"></div>\n    </div>\n    <div class=\"hench-area\" *ngIf=\"selected == 'hench'\">\n        <div class=\"column\">\n            <p class=\"node\">\n                <i class=\"fa {{_scheming.schemes[3].fa}}\" aria-hidden=\"true\" (click)=\"_scheming.schemePreview(3)\"></i>\n            </p>\n            <!--<p class=\"level\">{{_scheming.getSchemeCurrentLevel(0)+1}}</p> -->\n            <p class=\"node\">\n                <i class=\"fa {{_scheming.schemes[4].fa}}\" aria-hidden=\"true\" (click)=\"_scheming.schemePreview(4)\"></i>\n            </p>\n            <!--<p class=\"level\">{{_scheming.getSchemeCurrentLevel(1)+1}}</p> -->\n            <p class=\"node\">\n                <i class=\"fa {{_scheming.schemes[5].fa}}\" aria-hidden=\"true\" (click)=\"_scheming.schemePreview(5)\"></i>\n            </p>\n            <!--<p class=\"level\">{{_scheming.getSchemeCurrentLevel(2)+1}}</p> -->\n        </div>\n        <div class=\"column\"></div>\n        <div class=\"column\"></div>\n        <div class=\"column\"></div>\n        <div class=\"column\"></div>\n    </div>\n    <div class=\"operate-area\" *ngIf=\"selected == 'operate'\"></div>\n    <div class=\"lair-area\" *ngIf=\"selected == 'lair'\"></div>\n    <div *ngIf=\"_scheming.showPreview\" class=\"scheme-flyout\" [ngStyle]=\"{'background-color' : _scheming.previewScheme['flyout_color']}\">\n        <div class=\"inner-content\">\n            <i class=\"scheme-icon fa {{_scheming.previewScheme.fa}}\" aria-hidden=\"true\"></i>\n            <p class=\"scheme-name\">{{_scheming.previewScheme.name}} {{_scheming.previewSchemeLevel > 1 ? _scheming.previewSchemeLevel : ''}}</p>\n                <p class=\"benefit-header\">Benefit: </p>\n                <p class=\"benefit-text\">{{_scheming.previewSchemeDescription}} </p>\n            <p class=\"flavor-text\">{{_scheming.previewSchemeFlavor}}</p>\n            <p class=\"scheme-exp\"> {{_scheming.previewSchemeExp}}/{{_scheming.previewSchemeExpTarget}}</p>\n            <p class=\"node\" style=\"width:80%;margin-top:.5rem;font-family:'Prociono';border-radius:.5rem;font-size:1rem;\" [ngStyle]=\"{'background-color' : previewScheme['flyout_color']}\"\n                *ngIf=\"_scheming.previewScheme['ref'] != _player.currentScheme['ref']\" (click)=\"_scheming.startSchemingPreview()\">Learn {{_scheming.previewScheme.name}} {{_scheming.previewSchemeLevel > 1 ? _scheming.previewSchemeLevel : ''}}</p>\n        </div>\n\n\n    </div>\n\n</div>"
...
var SchemePanelComponent = (function () {
    function SchemePanelComponent(_player, _scheming, _data) {
        var _this = this;
        this._player = _player;
        this._scheming = _scheming;
        this._data = _data;
...
SchemePanelComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_player_service__["a" /* PlayerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_player_service__["a" /* PlayerService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_scheming_service__["a" /* SchemingService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_scheming_service__["a" /* SchemingService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__data_service__["a" /* DataService */]) === "function" && _c || Object])
