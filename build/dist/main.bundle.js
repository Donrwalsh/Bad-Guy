...
var AppComponent = (function () {
    function AppComponent(_player, _dataService, _http) {
        this._player = _player;
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._http.get('/api/schemes').subscribe(function (data) {
            console.log(data);
        });
...
var DataService = (function () {
    ...
    DataService.prototype.GET = function (uri, options) {
        if (Object(__WEBPACK_IMPORTED_MODULE_1_util__["isUndefined"])(options)) {
            options = {
                withCredentials: true,
                responseType: 'json'
            };
